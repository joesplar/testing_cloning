view: county_28d_historical {
  sql_table_name: `bigquery-public-data.covid19_public_forecasts.county_28d_historical`
    ;;

  dimension: county_fips_code {
    type: string
    description: "5-digit unique identifier of the county."
