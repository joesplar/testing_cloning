view: japan_prefecture_28d_historical {
  sql_table_name: `bigquery-public-data.covid19_public_forecasts.japan_prefecture_28d_historical`
    ;;
  ...
  dimension: prefecture_code {
    type: string
    description: "Unique identifier of the prefecture."
